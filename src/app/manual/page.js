...
const TOC = [
  ...
  { id: 'teacher-proctor', label: '　จัดครูคุมสอบ (แอดมิน)', indent: true },
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
        ...
        <Section id="teacher-examset" title="4. จัดข้อสอบ">
          ...
          <Steps items={[
            ...
            'จัดลำดับข้อ (เลื่อนขึ้น/ลง) และกำหนดคะแนนแต่ละข้อทางขวา (มีปุ่ม “กำหนดคะแนนเท่ากันทุกข้อ” ให้ตั้งครั้งเดียวทั้งชุด) — แบดจ์สีม่วงบอกจำนวนข้อและคะแนนรวมที่เลือกไว้ตอนนี้',
            'กด “สร้างชุดข้อสอบ”',
          ]} />
          <p>
            สลับมุมมองรายการข้อที่เลือกได้ 2 แบบด้วยปุ่ม <strong>&quot;เรียงตาม&quot;</strong>: <strong>&quot;ลำดับที่เลือก&quot;</strong>
            (เรียงตามที่ติ๊กไว้ ลากสลับลำดับเองได้) หรือ <strong>&quot;ตัวชี้วัด/ผลการเรียนรู้&quot;</strong> (จัดกลุ่มข้อสอบตามตัวชี้วัดให้อัตโนมัติ
            พร้อมพิมพ์หัวข้อตัวชี้วัดกำกับบนกระดาษคำถามด้วย — โหมดนี้ลากสลับลำดับเองไม่ได้)
          </p>
          <p>
        ...
        <Section id="teacher-duty" title="7. ตารางคุมสอบ">
          <p>
            สำหรับดูว่าวันไหน ห้อง/ชั้นใดสอบวิชาอะไรบ้าง (ใช้ร่วมกับรอบสอบแบบ &quot;ในตาราง&quot; ที่ตั้งไว้ตอนจัดสอบ)
            ครูทุกคนดูได้ — พิมพ์ตารางคุมสอบรายวันออกมาแปะประกาศได้
          </p>
        </Section>

        <Section id="teacher-proctor" title="8. จัดครูคุมสอบ (เฉพาะแอดมิน)">
          <p>
            เมนูสำหรับแอดมินมอบหมายว่าวันไหน ครูคนไหนคุมสอบห้อง/ชั้นใดบ้าง (ครูทั่วไปจะไม่เห็นเมนูนี้) — เลือกวันที่
            เลือกชั้น/ห้อง เลือกครูคุมสอบ แล้วกด &quot;มอบหมาย&quot;
          </p>
          <p>
            ครูที่ได้รับมอบหมายจะเห็นหน้ามอนิเตอร์คุมสอบของห้องนั้นในวันนั้นได้ (เมนู &quot;คุมสอบ&quot;) ไม่ว่าจะเป็นรอบสอบในตาราง
            หรือนอกตารางที่จัดในห้องเดียวกันวันนั้น — ส่วนรอบสอบนอกตาราง ครูที่สร้างข้อสอบเองดูมอนิเตอร์ของตัวเองได้อยู่แล้วโดยไม่ต้องมอบหมาย
          </p>
        </Section>

        <Section id="teacher-report" title="9. รายงาน (สอบออนไลน์)">
          <p>เลือกรอบสอบเพื่อดูผลคะแนนนักเรียนทุกคน สถานะการเข้าสอบ เวลาที่ใช้ทำข้อสอบ (ตั้งแต่เริ่มถึงส่งข้อสอบจริง) จำนวนครั้งที่สลับหน้าจอ พร้อมปุ่มรีเซ็ตให้สอบใหม่รายบุคคล</p>
          <p>
        ...
        <Section id="admin" title="สำหรับแอดมิน — ตั้งค่าระบบ">
          ...
          <Bullets items={[
            ...
            <><strong>Gemini API Key</strong> — คีย์ AI ที่ใช้สร้างข้อสอบในหน้าคลังข้อสอบ ใช้ร่วมกับระบบ ปพ.5 — มีปุ่ม &quot;ตรวจสอบเวอร์ชันปัจจุบัน&quot; ให้เช็คได้ว่าตอนนี้ระบบกำลังใช้โมเดล AI รุ่นไหนอยู่จริง</>,
            ...
            <><strong>ครูเข้าสู่ระบบล่าสุด</strong> — เวลาที่แต่ละครูเข้าสู่ระบบครั้งล่าสุด เรียงจากเข้าล่าสุดไปเก่าสุด (ใช้ร่วมกับระบบ ปพ.5 — เข้าระบบไหนก็อัปเดตเวลานี้เหมือนกัน)</>,
          ...
          <Note>
            การมอบหมายครูคุมสอบย้ายไปอยู่เมนู <strong>&quot;จัดครูคุมสอบ&quot;</strong> แยกต่างหากแล้ว (ยังเป็นเมนูที่แอดมินเท่านั้นเห็น
            แต่ไม่ได้อยู่ในหน้าตั้งค่าอีกต่อไป) — ดูรายละเอียดที่หัวข้อ &quot;8. จัดครูคุมสอบ&quot;
          </Note>
        </Section>
