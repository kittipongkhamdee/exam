        ...
        message={deleteTarget
          ? `ลบชุดข้อสอบ "${deleteTarget.title}"?\n\nรอบสอบที่ตั้งไว้จากชุดนี้จะถูกลบไปด้วย`
            + (deleteTarget.printed_quiz_id
              ? (deleteTarget.printed_has_scans
                ? '\n\n⚠ ชุดนี้มีกระดาษคำตอบ (OMR) ที่เคยพิมพ์ไว้แล้ว และมีนักเรียนสแกนส่งแล้ว — กระดาษคำตอบและเฉลยจะไม่ถูกลบไปด้วย ถ้าต้องการลบกระดาษคำตอบ ต้องไปลบเองที่หน้า "กระดาษคำตอบ"'
                : '\n\nชุดนี้มีกระดาษคำตอบ (OMR) ที่เคยพิมพ์ไว้แต่ยังไม่มีนักเรียนสแกนส่ง — จะถูกลบไปพร้อมกันด้วย')
              : '')
          : ''}
